                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-3 col-md-3 col-12 order-1 order-md-2">
                                    ...
                                    <ul className="list-unstyled footer-list mt-4">
                                        <li><Link href="/page-aboutus" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/>Features</Link></li>
                                        <li><Link href="/page-pricing" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Pricing</Link></li>
                                        <li><Link href="/portfolio-detail-four" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Faq</Link></li>
                                        <li><Link href="/blog-grid" className="text-foot d-flex align-items-center"><IoIosArrowForward className="me-1"/> Contact</Link></li>
                                    </ul>
                                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-sm-8 mt-4 mt-sm-0">
                            <div className="text-sm-end text-center">
                                <p className="mb-0 text-muted">{new Date().getFullYear()} ©<Link href="https://tltechnologies.net/" target="_blank" className="text-reset">TL TECHNOLOGIES</Link>.</p>
                            </div>
                        </div>
                    </div>
                </div>
